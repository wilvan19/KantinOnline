...
<body>
    <div class="container-scroller" style=>
        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start" style="background-color: #ffee93;">
                <div class="me-3">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-color: #ffee93;">
                <ul class="nav">
            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        ...
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Copyright Jak'n Will © 2024. All rights reserved.</span>
                    </div>
                </footer>
            </div>
            <!-- partial -->
