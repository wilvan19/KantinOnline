...
<body>
        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start pl-3" style="background-color: #fcf5c7;">

                <div>
                    <a class="navbar-brand brand-logo" >
                    <h1 style="font-family: 'Lucida Handwriting', cursive; font-size: 48px; color: #333;">Kants</h1>
                    </a>
                    <a class="navbar-brand brand-logo-mini">
                    <h1 style="font-family: 'Lucida Handwriting', cursive; font-size: 48px; color: #333;">K'</h1>
                    </a>
                </div>
            </div>
            <div class="navbar-menu-wrapper d-flex align-items-top" style="background-color: #fcf5c7;">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text">Whatsup Ngab, <span class="text-black fw-bold"></span></h1>
                        <p ><strong> LAPAR GAN? Pesen GASSS------------------------------------------------->>></strong> </p>
                    </li>
                </ul>
        ...
        <!-- HOME gambar -->
        <div>
            <img src="<?= base_url('public/images/dashboard/kantina.png') ?>" alt="Gambar Homeyes" width="1400" height="400">
        </div>
        <!-- partial -->
        <div class="container-fluid page-body-wrapper" style="background-color: #ffee93;">
            <!-- partial -->
            <div class="main-panel" style="margin-left: auto; margin-right:auto;">
            <div class="content-wrapper text-center">
                <article>
                    <br>
                    <p style="font-family: 'Lucida Handwriting', cursive; font-size: 34px; color: #333;">Kants</p>
                    <br>
                    <h2>Khas Makanannya, Khas Suasananya</h2>
                    <p><span> Kants</span> adalah tempat makan yang menawarkan berbagai pilihan kuliner lezat dalam suasana yang nyaman dan hangat. Nikmati menu utama yang menggugah selera, bersama dengan menu sampingan yang sempurna seperti kentang goreng renyah dan banana roll. Kami juga menyajikan minuman dingin yang menyegarkan dan minuman hot yang menenangkan, ideal untuk melengkapi pengalaman makan Anda. Kants, di mana setiap hidangan dan minuman dirancang untuk memuaskan selera Anda.</p>
                </article>
                <br>
            </div>
                <?php if ($makanan) : ?>
